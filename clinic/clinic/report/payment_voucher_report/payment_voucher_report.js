frappe.query_reports["Payment Voucher Report"] = {
	...
	onload: function (report) {
		...
		frappe.db.get_value("Doctor", { "user_id": user_mail/*"fahadbinslmah@gmail.com" */ }, "name").then((r) => {
			...
			let allowed_users = ["Nawaf Alotaibi","atheer alsaadan", "جمعه", "ناصر العريج","Rana Alqfari", "Dr.Nawaf Alshahrani","2Care ","Kholoud Alarfag","Nourah Alhnaia","Amir","Mohammed Eletrby", "Noura Alawaji"]
