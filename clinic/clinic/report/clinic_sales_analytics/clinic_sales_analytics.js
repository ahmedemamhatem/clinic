frappe.query_reports["Clinic Sales Analytics"] = {
	"filters": [
	...
	onload : function(frm){
		...
		frappe.db.get_value("Doctor", { "user_id": user_mail/*"fahadbinslmah@gmail.com" */ }, "name").then((r) => {
			...
			let allowed_users = ["Raghad Aljuhani","Nawaf Alotaibi","Nouf Almutairi","atheer alsaadan", "جمعه", "ناصر العريج", "Rana Alqfari", "Dr.Nawaf Alshahrani","2Care ","Kholoud Alarfaj","Nourah Alhnaia","Mohammed Eletrby", "Noura Alawaji"]
